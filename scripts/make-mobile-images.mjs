...
const JOBS = [
  { src: "blank-political.webp", out: "blank-political-mobile.webp" },
  { src: "timezones.webp", out: "timezones-mobile.webp" },
  // Markers overlay carries alpha — webp preserves it.
  { src: "cities-subnational-markers.png", out: "cities-subnational-markers-mobile.webp" },
];
